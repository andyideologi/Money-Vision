...
class NetWorking {
  ...
  Future<String> updateDetails(String id, String email, String location, String mobile, String blood) async {
    var request = http.MultipartRequest('POST', Uri.parse('https://fleenks.com/mv/api/fr-profile-update'));
    request.fields.addAll({
      'id': id,
      'pers_email': email,
      'location': location,
