...
class _ProfileState extends State<Profile> {
  ...
  TextEditingController emailController = TextEditingController(), locationController = TextEditingController(), mobileController = TextEditingController(), bloodController = TextEditingController();
  ...
  void DisplayChangePasswordDialog(BuildContext context) {
    ...
    showDialog(
      context: context,
      builder: (BuildContext context) => AlertDialog(
          title: Row(children: [Text("Update Password"), CloseButton()],),
          actions: [
            Form(
              ...
              children: [
                ...
                GestureDetector(
                  onTap: () async {
                    ...
                    await netWorking.getProfileDetails(Data.map['id'].toString()).then((value) {
                ...
                GestureDetector(
                  ...
                  Row(children: [
                    ...
                    Padding(padding: EdgeInsets.all(10),
                        child:
                        Text('Update Profile', style: TextStyle(fontSize: 17),))
                  ],),)),
    ...
    print(m.toString());
      showDialog(
            ...
            Column(
              ...
              children: [
               ...
               Row(
                ...
                Text('Company Details : ', style: TextStyle(fontSize: 18),)),
                Padding(padding: EdgeInsets.only(top: 10), child:
                Row(
                    children: [
                      Expanded(
                ...
                Row(
                    children: [
                      ...
                      Expanded(
                          ...
                          GestureDetector(
                              onTap: () async {
                                String url = 'https://fleenks.com/mv/'+filespath + m[0]['pan_file'];
                                await launch(url);
                              },
                              child:  Text(
                            m[0]['pan_no'],
                ...
                Row(
                    children: [
                      ...
                      Expanded(
                          ...
                          GestureDetector(
                              onTap: () async {
                                String url = 'https://fleenks.com/mv/'+filespath + m[0]['adhaar_file'];
                                await launch(url);
                              },
                              child:  Text(
                                m[0]['aadhar_no'],
        ...
        (m[0]['agreement_file'] != null)?
          Padding(padding: EdgeInsets.only(top: 10), child: GestureDetector(
            onTap: () async {
              String url = 'https://fleenks.com/mv/'+filespath + m[0]['agreement_file'];
              await launch(url);
            },
            child: Text('Agreement File'),
                ...
                Padding(padding: EdgeInsets.only(top: 10), child:GestureDetector(
                  onTap: ()
                    async {
                      String url = 'https://fleenks.com/mv/'+filespath + m[0]['kyc_photo'];
                      await launch(url);
                  },
                  child: Text('KYC'),
                )),
                      ...
                      Expanded(
                          ...
                          child: ( m[0]['id_proof_name'] != null)?
                              GestureDetector(onTap:()
                                async {
                                  String url = 'https://fleenks.com/mv/'+filespath + m[0]['id_proof_file'];
                                  await launch(url);
                              },child:
                          Text(
                            m[0]['id_proof_name'],
                    ...
                    children: [
                      ...
                      Expanded(
                          ...
                          GestureDetector(onTap:() async {
                            String url = 'https://fleenks.com/mv/'+filespath + m[0]['address_proof_file'];
                            await launch(url);
                          },child:
                          Text(
                ...
                Padding(padding: EdgeInsets.only(top: 20, bottom: 10), child:
                Text('Bank Details : ', style: TextStyle(fontSize: 18),)),
                Padding(padding: EdgeInsets.only(top: 10), child:
                Row(
                    children: [
                      Expanded(
              ...
              Container(
                ...
                GestureDetector(
                  ...
                  async {
                    ...
                    FocusScope.of(context).unfocus();
                    NetWorking apiObj = NetWorking(password: '', phoneNumber: '');
                    await apiObj.updateDetails(Data.map['id'].toString(), emailController.text, locationController.text, mobileController.text, bloodController.text).then((value) async {
                      Map valueMap = jsonDecode(value);
                      final snackBar =
                      SnackBar(content: Text(valueMap['message']));
                      ScaffoldMessenger.of(context)
